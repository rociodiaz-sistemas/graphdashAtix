...
import { getAlarms, updateAlarms, deleteAlarm, pauseAlarm } from './alarmWatcher';
import { GET_ALARMS, SET_LOADING_ALARMS, SET_ALARMS, SET_ALARMS_ERROR, UPDATE_ALARMS, DELETE_ALARM, PAUSE_ALARM } from '../actions/alarmActions';
